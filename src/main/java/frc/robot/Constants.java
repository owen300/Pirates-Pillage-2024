...
public final class Constants {
  ...
  public static final class SubsystemConstants {
    ...
    public static final int kIntakeCurrentThreshold = 14; 
    public static final boolean kIntakeDebounce = false; 
    public static final double kIntakeDebounceTime = 0.05; 
    ...
    public static final double kLiftLeadLeftP = 0.1; 
    ...
    public static final double kLiftLeadRightP = 0.1; 
