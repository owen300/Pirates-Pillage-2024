...
public class LimelightUtils {
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName) {
        var poseEntry = LimelightUtils.getLimelightNTTableEntry(limelightName, entryName);
    ...
    private static RawFiducial[] getRawFiducials(String limelightName) {
        var entry = LimelightUtils.getLimelightNTTableEntry(limelightName, "rawfiducials");
    ...
    public static RawDetection[] getRawDetections(String limelightName) {
        var entry = LimelightUtils.getLimelightNTTableEntry(limelightName, "rawdetections");
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        ...
        LimelightUtils.LimelightResults results = new LimelightUtils.LimelightResults();
        if (mapper == null) {
